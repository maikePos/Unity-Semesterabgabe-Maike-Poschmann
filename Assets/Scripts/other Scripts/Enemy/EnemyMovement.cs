...
public class EnemyMovement : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision) //wenn das Enemy mit einem GameObject, der den tag "Bullet" besitzt, kollidiert, dann soll dieser zerstört werden
    {
